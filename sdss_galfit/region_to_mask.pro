pro region_to_mask, input_image, reg_file, old_mask=old_mask, $
    output=output, savejpeg = savejpeg, overlap = overlap
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
if keyword_set(old_mask) then begin 
...
if NOT file_test( strcompress( reg_file, /remove_all ) ) then begin 
  ...
  if ( lines le 4 ) then begin 
    ...
    readf, 10, regions 
    close, 10
    if ( strcompress( regions[2], /remove_all ) ne 'image' ) then begin 
      message, 'The Coordinates for Regions should be in Image Unit !!'
    endif else begin 
      regions2 = strarr( lines - 3 )
      regions2 = regions[ 3 : ( lines - 1 ) ] 
      regions = regions2
      lines = lines - 3
    endelse
  endelse
...
if keyword_set( savejpeg ) then begin 
    jpeg_file = strcompress(savejpeg, /remove_all)
...
if keyword_set(output) then begin 
    ...
    output = 'object_mask.fits'
endelse
mwrfits, img_msk, output, header_msk, /create, /silent
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
